...
|define_files | Space-separated list of paths | Verilog include files containing `define directives to be converted to C #define directives in corresponding .h files (deprecated)
|depend | Space-separated list of VLNV identifiers | Tool-specific Dependencies
...
|tb_toplevel | Space-separated list of files | Testbench top-level C/C++/SC file
